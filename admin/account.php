                ...
                <tr class="hover:bg-slate-50/50 transition <?php echo $status==='disabled'?'opacity-50':''; ?>">
                    ...
                    <td class="px-4 py-3 text-right">
                        <div class="inline-flex items-center gap-1">
                            ...
                            <button onclick='openEditModal(<?php echo json_encode($u); ?>,<?php echo $classrooms_json; ?>)' class="p-1.5 rounded-lg text-amber-400 hover:text-amber-600 hover:bg-amber-50 transition" title="Edit">
